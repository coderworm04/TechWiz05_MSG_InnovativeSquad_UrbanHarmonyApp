...
if (isset($_GET['delete']) && $_SESSION['role'] == 'admin') {
    ...
    try {
        ...
        $stmt = $pdo->prepare("DELETE FROM tbl_website WHERE web_id = :web_id");
        $stmt->bindParam(':web_id', $web_id, PDO::PARAM_INT);
        ...
        $errorMessage = "An error occurred while deleting the website.";
    }
}
            ...
            <nav class="navbar bg-light navbar-light d-flex flex-column">
                ...
                <div class="navbar-nav w-100">
                    ...
                    if ($_SESSION['role'] == "admin") {
                        ...
                        <a href='website.php' class='nav-item active nav-link text-success fw-bold'><i class='fa fa-globe me-2'></i>User's Website</a>
                        ";
                    }
                    ?>
                </div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0 text-white">User's Website</h6>
                        <?php if ($_SESSION['role'] == "admin") {
                            echo "<a href='add_website.php' class='btn btn-success'>Add+</a>";
                        } ?>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="text-success">Website Name</th>
                                    <th scope="col" class="text-success">User Id</th>
                                    <th scope="col" class="text-success">Options</th>
                            ...
                            <tbody>
                                ...
                                try {
                                    ...
                                    $stmt = $pdo->query("SELECT web_id, website_name, user_id FROM tbl_website");

                                    while ($website = $stmt->fetch()) {
                                        echo "<tr>";
                                        echo "<td>" . $website['web_id'] . "</td>";
                                        echo "<td>" . htmlspecialchars($website['website_name']) . "</td>";
                                        echo "<td>" . htmlspecialchars($website['user_id']) . "</td>";
                                        echo "<td>
                                        <a class='btn btn-sm btn-warning me-2' href='edit_website.php?id=" . $website['web_id'] . "'>Edit</a>
                                        <a class='btn btn-sm btn-danger' href='website.php?delete=" . $website['web_id'] . "' onclick=\"return confirm('Are you sure you want to delete this website?');\">Delete</a>";
                                        echo"</td>";
                                        echo "</tr>";
                                    }
                                } catch (PDOException $e) {
