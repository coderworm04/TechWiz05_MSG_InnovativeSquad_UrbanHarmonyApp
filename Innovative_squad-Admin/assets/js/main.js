...
jQuery(document).ready(function($) {
    ...
    $('#circle1').circleProgress({
      ...
      $(this).find('strong').php(Math.round(60 * progress) + '<i>%</i>');
  });
    ...
    $('#circle2').circleProgress({
      ...
      $(this).find('strong').php(Math.round(70 * progress) + '<i>%</i>');
  });
    ...
    $('#circle3').circleProgress({
      ...
      $(this).find('strong').php(Math.round(30 * progress) + '<i>%</i>');
  });
    ...
    $('#circle4').circleProgress({
      ...
      $(this).find('strong').php(Math.round(90 * progress) + '<i>%</i>');
  });
