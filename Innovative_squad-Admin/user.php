            ...
            <nav class="navbar bg-light navbar-light d-flex flex-column">
                ...
                <div class="navbar-nav w-100">
                    ...
                    if ($_SESSION['role'] == "admin") {
                        echo "
                        <a href='user.php' class='nav-item active nav-link text-success fw-bold'><i class='fa fa-user me-2'></i>Users</a>
                ...
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <?php if ($_SESSION['role'] == "admin") {
                            echo "<a href='add_user.php' class='btn btn-success'>Add+</a>";
                        } ?>
                    </div>
