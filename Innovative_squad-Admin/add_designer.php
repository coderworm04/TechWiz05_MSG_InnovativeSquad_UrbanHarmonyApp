...
// Function to generate a color from a string (optional: used for styling purposes)
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        try {
            // Prepare and bind the SQL query for tbl_admin
            $stmt = $pdo->prepare("INSERT INTO tbl_admin (name, username, email, phone, dob, specialization, address, password) 
                                   VALUES (:name, :username, :email, :phone, :dob, :specialization, :address, :password)");
...
<body>
    ...
    <div class="bg-light text-center rounded p-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h3 class="mx-auto text-white">Add Designer</h3>
        </div>
        <form class="row g-3" method="POST" action="">
            ...
            <div class="col-md-6">
                <label for="validationCustom06" class="form-label">Specialization</label>
                <input type="text" class="form-control" id="validationCustom06" name="specialization" required>
            </div>
            <div class="col-md-6">
                <label for="validationCustom07" class="form-label">Address</label>
                <input type="text" class="form-control" id="validationCustom07" name="address" required>
            </div>
            <div class="col-12">
                <button class="btn btn-outline-warning" type="submit">Add Designer</button>
            </div>
        </form>
    </div>
</div>
